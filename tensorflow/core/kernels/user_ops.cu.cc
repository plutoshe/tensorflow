#include "tensorflow/core/kernels/user_ops.h"
...
template<typename T>
class LookaheadGPUOp<T, 1> : public OpKernel {
 public:
...
REGISTER_KERNEL_BUILDER(Name("Lookaheadgpu").Device(DEVICE_GPU), LookaheadGPUOp<float, 1>);
