...
#include "tensorflow/contrib/warpctc/kernels/moderngpu/include/device/ctascan.cu.h"
#include "tensorflow/contrib/warpctc/kernels/moderngpu/include/device/ctamerge.cu.h"
